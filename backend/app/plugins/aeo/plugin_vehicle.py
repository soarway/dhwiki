...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AEO 运输工具检测插件")
    parser.add_argument("--dir_tag", default="aeo_vehicle", help="知识库 dir_tag")
