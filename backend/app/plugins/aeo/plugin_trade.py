...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AEO 进出口检测插件")
    parser.add_argument("--dir_tag", default="aeo_trade", help="知识库 dir_tag")
