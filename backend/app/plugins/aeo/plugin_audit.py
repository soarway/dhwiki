...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AEO 内审及整改检测插件")
    parser.add_argument("--dir_tag", default="aeo_audit", help="知识库 dir_tag")
