...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="AEO 货物收发检测插件")
    parser.add_argument("--dir_tag", default="aeo_cargo", help="知识库 dir_tag")
